...
class TripDetails extends React.Component {
    ...
    render() {
        ...
        const selectedTrip = this.context.trips.find(
            trip => trip.id.toString() === this.props.match.params.tripId
        );
        ...
        if (!selectedTrip.days) {
            ...
            return (
                <Switch>
                                                              ...
                                                              .map((activity, index) => {
                                                                  return (
                                                                      <span key={index} id="day">
                                                                          <h3 className="start_time">
                                                                              {activity.start_time}{' '}
                                                                              {activity.meridiem}
                                                                          </h3>
                                                                          <p
                                                                              id="trip-details-activity"
                                                                              className="activity"
                                                                          >
                                                                              {activity.activity}
                                                                          </p>
                    ...
                    <PrivateRoute
                        exact
                        path={'/trip/:tripId/day/:dayId/edit/:activityId'}
